...
based on the selected script, final topic, tone, and requested output language.
"""
...
def music_node(state: ContentStudioState) -> ContentStudioState:
    ...
    if language == "ko":
        ...
        suno_prompt = (
            f"{final_topic}을 주제로 한 30초 숏폼 영상용 배경음악을 만들어줘. "
        ...
        suno_prompt = (
            f"Create a 30-second background track for a short-form video about {final_topic}. "
            f"Tone: {tone}. "
